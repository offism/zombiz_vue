<template>
  <section class="FirstCounter">
    <div class="container">
      <div class="first-counter__box">
        <div class="row">
          <div class="col-3 fc__pacet">
            <div class="row">
              ...
              <div class="fc-pacet-text__box col-7">
                <div class="row">
                  <div class="counter" data-target="3280">0</div>
          ...
          <div class="col-3 fc__pacet">
            <div class="row">
              ...
              <div class="fc-pacet-text__box col-7">
                <div class="row">
                  <div class="counter" data-target="1640">0</div>
          ...
          <div class="col-3 fc__pacet">
            <div class="row">
              ...
              <div class="fc-pacet-text__box col-7">
                <div class="row">
                  <div class="counter" data-target="7380">0</div>
          ...
          <div class="col-3 fc__pacet">
            <div class="row">
              ...
              <div class="fc-pacet-text__box col-7">
                <div class="row">
                  <div class="counter" data-target="6560">0</div>
...
.FirstCounter {
  position: relative;
  background: url("./../../public/images/counter/counter-banner.jpg") no-repeat;
